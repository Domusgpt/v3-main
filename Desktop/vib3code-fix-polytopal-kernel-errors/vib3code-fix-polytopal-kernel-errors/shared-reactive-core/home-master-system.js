...
class HomeBasedReactiveSystem {
  constructor() {
    ...
    this.FIXED_GEOMETRIES = {
      homepage: 'hypercube',
      technology: 'hypertetrahedron', // Corrected from 'tetrahedron'
      ema: 'hypersphere',          // Corrected from 'sphere'
      pricing: 'hypercube',        // WAS: 'crystal' - Placeholder: 'crystal' geometry not in core
      docs: 'hypercube',           // WAS: 'fractal' - Placeholder: 'fractal' geometry not in core
      about: 'hypercube'           // WAS: 'torus' - Placeholder: 'torus' geometry not in core
    };
